  ...
  return (
    <div className={`min-h-screen ${COLORS.backgroundGradient} ${COLORS.textPrimary}`}>
      ...
      <nav className="flex items-center justify-between px-6 md:px-16 py-6">
        ...
        <button className={`${COLORS.buttonPrimary} transition duration-300 px-5 py-2 rounded-full font-medium shadow-lg`}>
          Sign In
        </button>
      </nav>
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-16 py-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <button className={`${COLORS.buttonPrimary} transition duration-300 px-6 py-3 rounded-full text-lg font-semibold shadow-md`}>
            Get Started
          </button>
        </div>
